...
/**
 * a linked class implemented by node.
 * 
 * @author Group24
...
public class LinkedList<E> {
    ...
    /**
     * an private node class used to implement the list
     * 
     * @author Group24
     *         Haisheng Xu (haisheng),
     *         Zhengyu Liu (samueliu14),
    ...
    /**
     * a helper class that implements an iterator
     * 
     * @author Group24
     *         Haisheng Xu (haisheng),
     *         Zhengyu Liu (samueliu14),
    ...
    private class LinkedListIterator implements Iterator<E> {
        ...
        /**
         * return the value of next object
         * 
         * @return the data of next object
         */
        public E next() {
            if (!hasNext()) {
